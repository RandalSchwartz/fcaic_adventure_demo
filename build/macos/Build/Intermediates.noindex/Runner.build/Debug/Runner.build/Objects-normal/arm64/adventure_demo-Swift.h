...
#ifndef ADVENTURE_DEMO_SWIFT_H
#define ADVENTURE_DEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="adventure_demo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14adventure_demo11AppDelegate")
...
SWIFT_CLASS("_TtC14adventure_demo17MainFlutterWindow")
